...
import { quantityInputs, isIEBrowser, isEdgeBrowser, findIndex, stickyContentHandle } from '../../../../../utils';
...
function ProductDetailOne( props ) {
    ...
    return (
        <StickyBox className="product-details details-fullwidth sticky-content" offsetTop={ 80 }>
