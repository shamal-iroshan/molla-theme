    ...
    return (
        <>
            ...
            <div className="main">
                ...
                <Breadcrumb title="Default With Sidebar" parent1={ [ "Blog", "blog/classic" ] } adClass="mb-3" />
                                ...
                                <article className="entry single-entry">
                                    ...
                                    <div className="entry-body">
                                        ...
                                        <div className="entry-content editor-content">
                                            ...
                                            <img src={ `${process.env.PUBLIC_URL}/assets/images/blog/single/2.jpg` } alt="desc" className="float-left" />
                                            ...
                                            <img src={ `${process.env.PUBLIC_URL}/assets/images/blog/single/3.jpg` } alt="desc" />
